package org.machinemc.primallib.v1_21;
...
import org.machinemc.primallib.v1_21.impl.advancement.AdvancementServiceImpl;
import org.machinemc.primallib.v1_21.impl.messaging.PluginMessageServiceImpl;
import org.machinemc.primallib.v1_21.impl.metadata.MetadataServiceImpl;
...
import org.machinemc.primallib.v1_21.listeners.packet.clientbound.*;
import org.machinemc.primallib.v1_21.listeners.packet.serverbound.configuration.ConfigurationAcknowledgedPacketListener;
import org.machinemc.primallib.v1_21.listeners.packet.clientbound.configuration.ConfigurationFilteringPacketListener;
import org.machinemc.primallib.v1_21.listeners.packet.serverbound.*;

import java.util.ArrayList;
import java.util.List;

@SuppressWarnings("UnstableApiUsage")
public class VersionBootstrap_v1_21 implements VersionBootstrap {
    ...
    public void bootstrap(JavaPlugin plugin, PluginProviderContext context) {
        ...
        // Server-bound
        listeners.add(new ClientCommandPacketListener());
        ...
        listeners.add(new RenameItemPacketListener());
