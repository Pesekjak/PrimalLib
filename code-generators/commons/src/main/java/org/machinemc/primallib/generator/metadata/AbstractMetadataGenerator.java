...
import org.machinemc.primallib.generator.DataGenerator;
...
/**
 * Generator for entity metadata values.
 */
@Getter
public abstract class AbstractMetadataGenerator implements DataGenerator {
    ...
    protected Map<String, EntityTypeData> entityTypeData = new TreeMap<>();

    protected AbstractMetadataGenerator(ProtocolVersion version) {
     ...
     */
    public record EntityTypeData(String name, @Nullable String inherits, List<EntityData.Field<?>> fields) {
        ...
        public static EntityTypeData deserialize(JsonObject json) {
            ...
            String inherits = json.has("inherits")
                    ...
                    : null;
            List<EntityData.Field<?>> fields = new ArrayList<>();
            json.getAsJsonArray("fields").asList().stream()
                    ...
                    .map(jsonObject -> {
                        ...
                        return new EntityData.Field<>(fieldName, index, serializer);
                    })
                    .forEach(fields::add);
        ...
        public EntityTypeData {
            ...
            fields.sort(Comparator.comparingInt(EntityData.Field::index));
        }
        ...
        public JsonObject serialize() {
            ...
            fields.stream()
                    .map(field -> {
                        ...
                        jsonObject.addProperty("index", field.index());
                        jsonObject.addProperty("serializer", Serializer.getName(field.serializer()));
                        return jsonObject;
                    })
